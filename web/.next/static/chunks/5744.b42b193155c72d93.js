"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[5744],{45744:(e,t,i)=>{i.r(t),i.d(t,{W3mEmailLoginView:()=>$,W3mEmailOtpWidget:()=>d.H,W3mEmailVerifyDeviceView:()=>y,W3mEmailVerifyOtpView:()=>p,W3mUpdateEmailPrimaryOtpView:()=>O,W3mUpdateEmailSecondaryOtpView:()=>C,W3mUpdateEmailWalletView:()=>x});var r=i(93481),n=i(97418),a=i(55480),o=i(70417),l=i(81701),s=i(67869),c=i(65374),u=i(12319),h=i(36211),d=i(74883);let p=class extends d.H{constructor(){super(...arguments),this.onOtpSubmit=async e=>{try{if(this.authConnector){let t=r.W.state.activeChain,i=n.x.getConnections(t),u=a.H.state.remoteFeatures?.multiWallet,h=i.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),o.E.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),t)await n.x.connectExternal(this.authConnector,t);else throw Error("Active chain is not set on ChainControll");if(o.E.sendEvent({type:"track",event:"CONNECT_SUCCESS",properties:{method:"email",name:this.authConnector.name||"Unknown"}}),a.H.state.remoteFeatures?.emailCapture)return;if(a.H.state.siwx)return void l.W.close();if(h&&u){s.I.replace("ProfileWallets"),c.P.showSuccess("New Wallet Added");return}l.W.close()}}catch(e){throw o.E.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:u.w.parseError(e)}}),e}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),o.E.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};p=function(e,t,i,r){var n,a=arguments.length,o=a<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,r);else for(var l=e.length-1;l>=0;l--)(n=e[l])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o}([(0,h.EM)("w3m-email-verify-otp-view")],p);var m=i(83138),f=i(98410),w=i(10899);i(40575),i(90721),i(48352),i(41163);let g=(0,h.AH)`
  wui-icon-box {
